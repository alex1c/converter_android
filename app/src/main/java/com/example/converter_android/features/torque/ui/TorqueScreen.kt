package com.example.converter_android.features.torque.ui
...
/**
 * Main screen for torque conversion.
 */
@Composable
fun TorqueScreen(
	...
	Column(
		...
		Row(
			...
			Text(
				text = stringResource(com.forestmusic.converter_android.R.string.torque_converter_title),
...
private fun UnitDropdown(
	...
	units: List<TorqueUnit>,
	onUnitSelected: (TorqueUnit) -> Unit,
	modifier: Modifier = Modifier
) {
